                ...
                <div className="col-lg-6 order-lg-last " style={{backgroundColor:"#DDE6ED"}}>
                  <div className="card-body p-md-5 mx-md-4">
                    ...
                    <form onSubmit={onSubmit}>
                      <h4 className="mt-1 mb-4 pb-1 text-center" style={{fontSize:"30px"}}>Student Login</h4>
                      ...
                      <div className="text-center pt-1 mb-5 mt-5 pb-1">
                        <button className="btn btn-primary btn-block w-100 fa-lg  mb-3" onClick={onSubmit} type="button">
                          Log in
                        </button>
                        <div><a className='text-primary' href="/sforgot">Forgot password ?</a></div>
                      </div>
