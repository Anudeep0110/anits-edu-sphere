    ...
    <div className='h-screen w-full bg-slate-100'>
        ...
        <div className='w-full h-full flex flex-col items-center'>
            ...
            <div className='flex flex-col text-center font-semibold hover:font-bold text-gray-900'>
                        <div onClick={() => {navigate('/dashboard',{state:{role:'faculty',fname:'Traning and Placement'}})}} className='bg-[#1f4886] rounded text-white font-medium md:text-5xl text-3xl shadow hover:scale-105 hover:shadow-black hover:shadow-lg flex justify-center items-center w-[75px] md:w-[100px] md:h-[100px] h-[75px]'><FcDepartment /></div>
