          ...
          <div className="col-xl-10">
            <div className="card rounded-3 text-black">
              <div className="row g-0">
                <div className="col-lg-6 order-lg-last " style={{backgroundColor:"#DDE6ED"}}>
                  <div className="card-body p-md-5 mx-md-4">
                    ...
                    <form>
                      <h4 className="mt-1 mb-4 pb-1 text-center" style={{fontSize:"30px"}}>Department Login</h4>
                      <div className="form-outline mb-4">
                        <input
                          type="email"
                          id="form2Example11"
                          className="mt-4 mb-3 login-form-input"
                          placeholder="Username"
                        />
                        
                      </div>
                      <div className="form-outline mt-1 mb-5 pb-1">
                        <input
                          type="password"
                          id="form2Example22"
                          className=" my-3 login-form-input"
                      ...
                      <div className="text-center pt-1 mb-5 pb-1">
                        <button className="btn btn-primary btn-block w-100 fa-lg  mb-3" type="button">
                          Log in
                        </button>
                        <div><a className="text-muted" href="#!">Forgot password?</a>
                      </div></div>
                ...
                <div className="col-lg-6 d-flex align-items-center gradient-custom-2" style={{backgroundImage:"url('assets/anits.jpg')"}}>
                </div>
              </div>
            </div>
          </div>
